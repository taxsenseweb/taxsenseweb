...
const WhatsAppButton = () => {
  ...
  const phoneNumber = "01730586145";
  const message = "Hello! I would like to know more about your tax services.";
  ...
  const handleWhatsAppClick = () => {
    const whatsappUrl = `https://wa.me/88${phoneNumber}?text=${encodeURIComponent(
      message
    )}`;
